...
temp_str = '''Все счастливые семьи похожи друг на друга, каждая несчастливая семья несчастлива по-своему.
...
temp_str = temp_str.replace('«', '')
temp_str = temp_str.replace('»', '')
#temp_str = temp_str.replace('-', ' ')   ## данная строчка уберет из сложных союзов, предлогов и т.д. дефис, нужно ли ее выполнять?
print(temp_str)
print()
...
new_list_2 = list(dict_temp.values())
new_list_2.sort(reverse=True)
print(new_list_2[:5])
new_set = ()
new_set = set(new_list_2)
print(new_set)
